...
var FiltersVuexModule = /** @class */ (function(_super) {
  ...
  function FiltersVuexModule() {
    ...
    _this.mode = "buy";
    _this.page = PropertiesModule.currentPageNumber;
    _this.filtersLoaded = false;
    _this.turnOffSwitch = false;
    _this.minPrice = 150000;
    _this.maxPrice = 10000000;
  ...
  Object.defineProperty(FiltersVuexModule.prototype, "Prices", {
    get: function() {
      var prices = [this.minPrice, this.minPrice];
      return prices;
    },
    enumerable: true,
    configurable: true
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              utils.processCheckBoxFilters(response.data.propertyTypes)
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              utils.processCheckBoxFilters(response.data.features)
            ];
          case 3:
            features = _a.sent();
            ...
            console.log("LOOKUP DATA SUCCESSFULLY LOADED");
            _a.label = 4;
          case 4:
            return [2 /*return*/];
        }
  ...
  // This function is Core. It takes in a
  FiltersVuexModule.prototype.SyncFiltersWithQueryString = function(query) {
    return __awaiter(this, void 0, void 0, function() {
      var split, _i, _a, _b, key, value;
        ...
        switch (_a.label) {
          case 0:
            ...
            if (payload.type === "propertyTypes") {
              itemIndex = this.filters.propertyTypes.findIndex(function(i) {
                return i.name == payload.data.name;
              });
              if (itemIndex >= 0) {
            ...
            if (payload.type === "features") {
              itemIndex = this.filters.features.findIndex(function(i) {
                return i.name == payload.data.name;
              });
              if (itemIndex >= 0) {
  ...
  FiltersVuexModule.prototype.calcQueryString = function() {
    return __awaiter(this, void 0, void 0, function() {
      var bathRooms,
        ...
        querySringParams;
      return __generator(this, function(_a) {
        bathRooms = utils.serializeNumbersArrayToStringArray(
          this.filters.bathRooms
        );
        bedRooms = utils.serializeNumbersArrayToStringArray(
          this.filters.bedRooms
        );
        parkingSpaces = utils.serializeNumbersArrayToStringArray(
          this.filters.parking
        );
        features = utils.serializeCheckBoxesToStringArray(
          this.filters.features
        );
        propertyTypes = utils.serializeCheckBoxesToStringArray(
          this.filters.propertyTypes
        );
        suburbs = this.filters.suburbs
          .toString()
          .split(",")
          .toString();
  ...
  FiltersVuexModule.prototype.SET_PROPERTY_TYPES_LOOKUP_FILTERS = function(
    data
  ) {
    this.lookup_propertyTypes = data;
  };
  FiltersVuexModule.prototype.SET_PROPERTY_FEATURES_LOOKUP_FILTERS = function(
    data
  ) {
  ...
  FiltersVuexModule.prototype.SET_PARKING_SPACES_LOOKUP_FILTERS = function(
    data
  ) {
  ...
  __decorate([Action], FiltersVuexModule.prototype, "loadLookupFilters", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateSearch", null);
  __decorate(
    [Action],
    FiltersVuexModule.prototype,
    "processSearializedQueryString",
    null
  );
  __decorate(
    [Action],
    FiltersVuexModule.prototype,
    "SyncFiltersWithQueryString",
    null
  );
  __decorate([Action], FiltersVuexModule.prototype, "turnOfSwitch", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateQueryString", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateFilter", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateBedrooms", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateBathrooms", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateParking", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateMinPrice", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateMaxPrice", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateMode", null);
  __decorate([Action], FiltersVuexModule.prototype, "updatePage", null);
  __decorate([Action], FiltersVuexModule.prototype, "updateCheckBoxes", null);
  __decorate([Action], FiltersVuexModule.prototype, "calcQueryString", null);
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_UI_UPDATE", null);
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_LOOKUPS_LOADED",
  ...
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_PROPERTY_TYPES_LOOKUP_FILTERS",
    null
  );
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_PROPERTY_FEATURES_LOOKUP_FILTERS",
    null
  );
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_BEDROOMS_LOOKUP_FILTERS",
    null
  );
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_BATHROOMS_LOOKUP_FILTERS",
    null
  );
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_PARKING_SPACES_LOOKUP_FILTERS",
    null
  );
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_MODE", null);
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_QUERY_STRING", null);
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_SERIALIZED_QUERY_STRING",
    null
  );
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_MIN_PRICE", null);
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_MAX_PRICE", null);
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_BEDROOMS", null);
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_BATHROOMS", null);
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_PARKING", null);
  __decorate([Mutation], FiltersVuexModule.prototype, "SET_PAGE", null);
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "SET_TURNOFF_SWITCH",
  ...
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "REMOVE_PROPERTY_TYPE_FILTER",
    null
  );
  __decorate(
    [Mutation],
    FiltersVuexModule.prototype,
    "ADD_PROPERTY_TYPE_FILTER",
    null
  );
  __decorate(
    [Mutation],
