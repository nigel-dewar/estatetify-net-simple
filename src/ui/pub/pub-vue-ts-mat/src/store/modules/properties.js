...
var PropertiesVuexModule = /** @class */ (function(_super) {
  ...
  Object.defineProperty(PropertiesVuexModule.prototype, '_Count', {
    // all the getters
    get: function() {
      return this.count;
    },
  ...
  PropertiesVuexModule.prototype.GetOneProperty = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, api.fetchOneProperty()];
          case 1:
            response = _a.sent();
  ...
  PropertiesVuexModule.prototype.GetPropertyImageForThumbnail = function(
    query
  ) {
    return __awaiter(this, void 0, void 0, function() {
      var response;
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, api.fetchPropertyImageForThumbnail(query)];
          case 1:
            response = _a.sent();
  ...
  PropertiesVuexModule.prototype.GetPropertyImages = function(query) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, api.fetchPropertyImages(query)];
          case 1:
            response = _a.sent();
  ...
  PropertiesVuexModule.prototype.GetPropertyDetails = function(slug) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, api.fetchProperty(slug)];
          case 1:
            response = _a.sent();
            this.SET_PROPERTY(response.data);
            return [2 /*return*/];
  ...
  PropertiesVuexModule.prototype.GetPropertyDescription = function(query) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, api.fetchPropertyDescription(query)];
          case 1:
            response = _a.sent();
  ...
  PropertiesVuexModule.prototype.GetProperties = function(query) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, api.fetchProperties(query)];
          case 1:
            response = _a.sent();
  ...
  PropertiesVuexModule.prototype.SearchSuburbs = function(query) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, api.searchSuburbs(query)];
          case 1:
            response = _a.sent();
  ...
  // MUTATIONS
  PropertiesVuexModule.prototype.SET_PROPERTY_IMAGE_FOR_THUMBNAL = function(
    data
  ) {
  ...
  __decorate([Action], PropertiesVuexModule.prototype, 'GetOneProperty', null);
  __decorate(
    [Action],
    PropertiesVuexModule.prototype,
    'GetPropertyImageForThumbnail',
    null
  );
  __decorate(
    [Action],
  ...
  __decorate([Action], PropertiesVuexModule.prototype, 'UpdateProperty', null);
  __decorate(
    [Action],
    PropertiesVuexModule.prototype,
    'GetPropertyDetails',
  ...
  __decorate([Action], PropertiesVuexModule.prototype, 'GetProperties', null);
  __decorate([Action], PropertiesVuexModule.prototype, 'SearchSuburbs', null);
  __decorate(
    [Action],
    PropertiesVuexModule.prototype,
  ...
  __decorate(
    [Mutation],
    PropertiesVuexModule.prototype,
    'SET_PROPERTY_IMAGE_FOR_THUMBNAL',
    null
  );
  __decorate(
    [Mutation],
  ...
  __decorate([Mutation], PropertiesVuexModule.prototype, 'SET_PROPERTY', null);
  __decorate(
    [Mutation],
    PropertiesVuexModule.prototype,
  ...
  __decorate(
    [Mutation],
    PropertiesVuexModule.prototype,
    'SET_SEARCHED_SUBURBS',
    null
  );
  __decorate(
    [Mutation],
    PropertiesVuexModule.prototype,
    'SET_SELECTED_SUBURBS',
    null
  );
