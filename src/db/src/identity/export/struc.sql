...
CREATE TABLE `permission_claims` (
  ...
  KEY `IX_permission_claims_PropertyPermissionId` (`PropertyPermissionId`),
  ...
  CONSTRAINT `FK_permission_claims_propertypermission_PropertyPermissionId` FOREIGN KEY (`PropertyPermissionId`) REFERENCES `propertypermission` (`Id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `propertypermission`
--
...
CREATE TABLE `propertypermission` (
  ...
  `AgencyId` longtext,
  PRIMARY KEY (`Id`),
  KEY `IX_propertypermission_PropertyId` (`PropertyId`),
  CONSTRAINT `FK_propertypermission_properties_PropertyId` FOREIGN KEY (`PropertyId`) REFERENCES `properties` (`Id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-02-07 19:38:23
