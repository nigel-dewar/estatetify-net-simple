...
namespace Console.Functions
{
    public class Properties
    {
        ...
        public Properties(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        internal void CreatePropertiesForCode(PostCode code, List<Agency> agencies)
        {
            ...
            if (!props.Any())
            {
                ...
                try
                {
                    ...
                    // count = how many properties to create per postcode
                    int count = 1;
        ...
        private Listing GenListing(string Code, string type)
        {
            try
            {
                decimal price;
                ...
                var agent = agency.Agents.FirstOrDefault();
        ...
        private List<Image> GenImages(string propertyId)
        {
            ...
            foreach (var img in bigImages)
            {
                ...
                var imagelId = Guid.NewGuid().ToString();
        ...
        private PropertyType GenPropertyType()
        {
            ...
            {
                propertyTypes = _context.property_types.ToList();
            }
        ...
        private void AddPropertyTypes(ApplicationDbContext context)
        {
            if (context.property_types.Any() == false)
            {
