...
namespace Infrastructure.Repositories
{
    public class PostCodesRepository: IPostCodesRepository
    {
        ...
        public PostCodesRepository(DataContext context)
        {
            _context = context;
        }

        public async Task<List<PostCodeDto>> FindPostCodesByAny(string q)
        {
            try
            {
                var Query = $"%{q?.ToLower()}%";
        ...
        public async Task<List<PostCodeDto>> FindPostCodesBySlug(string q)
        {
            try
            {
                using (_context)
