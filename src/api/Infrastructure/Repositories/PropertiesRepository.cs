...
namespace Infrastructure.Repositories
{
    public class PropertiesRepository : IPropertiesRepository
    {
        ...
        public PropertiesRepository(DataContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<PropertiesFindDto> FindProperties(string mode, int? page, string suburbs, string propertyTypes, string features, int? minPrice, int? maxPrice, string bedRooms, string bathRooms, string parking)
        {
            try
            {
                ...
                var props = _mapper.Map<List<Property>, List<PropertyDto>>(results);

                // return results with total amount as well
                var returnObject = new PropertiesFindDto
                {
                    Total = total,
                    Properties = props,
        ...
        public async Task<PropertyDto> GetPropertyBySlug(string slug)
        {
            try
            {
                using (_context) {
